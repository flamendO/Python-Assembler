...
struct lexem { 
  ...
  int next_parse_is(list_t *lexems, int (* parse_callback) (list_t *lexems) ); // Renvoie -1 si la liste des lexeme suivant le lexeme actuel ne parse pas avec la fonction callback, 0 sinon
