...
extern fifo *impossible_fifo; //variable externe au cas ou l'expression régulière contienne une erreur
//extern char_group *impossible_chargroup; //idem mais dans les groupes de caractères
